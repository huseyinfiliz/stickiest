...
use HuseyinFiliz\Stickiest\Listener;
use HuseyinFiliz\Stickiest\Post\DiscussionSuperStickiedPost;
use HuseyinFiliz\Stickiest\Provider\PinProvider;
use HuseyinFiliz\Stickiest\Query\StickiestFilterGambit;
use HuseyinFiliz\Stickiest\Query\TagStickyFilterGambit;
use HuseyinFiliz\Stickiest\TagStickyState;
...
return [
    ...
    (new Extend\Settings())
        ->default('huseyinfiliz-stickiest.badge_icon', 'fas fa-layer-group')
        ->default('huseyinfiliz-stickiest.display_tag_sticky', '1')
        ->serializeToForum('stickiest.badge_icon', 'huseyinfiliz-stickiest.badge_icon'),
